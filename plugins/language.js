function changeLang(lang_string) {
  if(localStorage.getItem("language")=='vi'){
			...
			$('#menu').html('<li><img src="images/top_logo.png" width="442" height="100" class="top_left_logo"></li>\
        <li id="l1"><a href="login.html"><img src="images/icon_login.png" width="75" height="75" class="menu_icon"/>Giới thiệu</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="language.html"><img src="images/icon_lang.png" width="75" height="75" class="menu_icon"/>Ngôn ngữ</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="library.html"><img src="images/icon_library.png" width="75" height="75" class="menu_icon"/>Báo cáo thường niên</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="about.html"><img src="images/icon_about.png" width="75" height="75" class="menu_icon"/>Báo cáo quý</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="list-articles.html"><img src="images/icon_rate.png" width="75" height="75" class="menu_icon"/>Công bố thông tin</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="#" onclick="navigator.app.exitApp();"><img src="images/icon_exit.png" width="75" height="75" class="menu_icon"/>Liên hệ</a></li>');
			...
			$('.tc_title').replaceWith('<span class="tc_title">Nội dung báo cáo:</span>');
	...
	if(localStorage.getItem("language")=='en'){
			...
			$('#menu').html('<li><img src="images/top_logo.png" width="442" height="100" class="top_left_logo"></li>\
        <li id="l1"><a href="login.html"><img src="images/icon_login.png" width="75" height="75" class="menu_icon"/>About Us</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="language.html"><img src="images/icon_lang.png" width="75" height="75" class="menu_icon"/>Language</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="library.html"><img src="images/icon_library.png" width="75" height="75" class="menu_icon"/>Annual Reports</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="about.html"><img src="images/icon_about.png" width="75" height="75" class="menu_icon"/>Quartely Reports</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="list-articles.html"><img src="images/icon_rate.png" width="75" height="75" class="menu_icon"/>Announcements</a></li>\
        <li><div class="menu_line"></div></li>\
        <li><a href="#" onclick="navigator.app.exitApp();"><img src="images/icon_exit.png" width="75" height="75" class="menu_icon"/>Contacts Us</a></li>');
			...
			$('.tc_title').replaceWith('<span class="tc_title">Table of Report:</span>');
...
$(document).ready(function(){
	...
	if(!app_lang || app_lang == 'null' || app_lang == '' || app_lang == 'false' || app_lang == 'undefined'){ window.localStorage.setItem("language","vi"); }
